...
const LocaleTranslationData = {
	"en": {
		...
		"conversion.create.failure": "Failed to create a conversion with error: ",
		...
		"conversion.create.success": "Successfully created a conversion.",
		...
		"conversion.delete.segment.earlier": "Are you sure you want to delete the segment from {start} to {end} and update the previous one?",
		"conversion.delete.segment.later": "Are you sure you want to delete the segment from {start} to {end} and update the next one?",
		...
		"conversion.edit.conversion": "Details/Edit Conversion",
		"conversion.edit.segment": "Edit Conversion Segment",
		"conversion.error.datetime.invalid": "Invalid format. Use YYYY-MM-DD HH:mm:ss",
		"conversion.error.segment.splitTime": "Split time must be strictly between the segment start and end.",
		"conversion.error.split.beforeStart": "The split time must come after this segment's start time",
		"conversion.error.split.afterEnd": "The split time must come before this segment's end time",
		"conversion.error.split.time.invalid": "Invalid split time. Please use format YYYY-MM-DD or YYYY-MM-DD HH:mm:ss.",
		...
		"conversion.overall": "Overall Conversion",
		"conversion.overall.delete": "Delete Overall Conversion",
		"conversion.overall.discard": "Discard Overall Changes",
		"conversion.overall.save": "Save Overall Conversion",
		"conversion.overall.save.error": "Failed to update conversion.",
		"conversion.overall.save.success": "Conversion updated successfully.",
		"conversion.overall.subtitle": "This section defines the overall conversion between units.",
		"conversion.pattern": "Pattern",
		"conversion.pattern.no": "No Pattern",
		"conversion.represent": "Conversion Represent:",
		"conversion.segment.delete.error": "An error occurred while deleting the segment.",
		"conversion.segment.delete.success": "Successfully deleted conversion segment.",
		"conversion.segment.split.error": "An error occurred while splitting the segment.",
		"conversion.segment.split.success": "Successfully split conversion segment.",
		"conversion.segment.save.error": "An error occurred while saving the segment.",
		"conversion.segment.save.success": "Segment saved successfully.",
		"conversion.segment.warning.invalidStartRange": "Start time must be after the previous segment's end and before this segment's end",
		"conversion.segment.warning.invalidEndRange": "End time must be before the next segment's start and after this segment's start",
		"conversion.segment.warning.previousAdjusted": "The previous segment's end time was adjusted to match the new start time",
		"conversion.segment.warning.previousAdjustFailed": "Failed to adjust the previous segment.",
		"conversion.segment.warning.nextAdjusted": "The next segment's start time was adjusted to match the new end time",
		"conversion.segment.warning.nextAdjustFailed": "Failed to adjust the next segment.",
		"conversion.segments.table": "Conversion Segments Table",
		"conversion.segments.table.subtitle": "This section shows how the conversion behaves over specific time periods.",
		...
		"conversion.split.datetime.placeholder": "YYYY-MM-DD HH:mm:ss (complete)",
		"conversion.split.datetime.prompt": "Enter the datetime (YYYY-MM-DD HH:mm:ss) to split the segment:",
		...
		"conversion.table.delete.earlier": "Delete Earlier\u2191",
		"conversion.table.delete.later": "Delete Later\u2193",
		"conversion.table.split.earlier": "Split Earlier\u2191",
		"conversion.table.split.later": "Split Later\u2193",
		"conversion.time.end": "End time",
		"conversion.time.start": "Start time",
		...
		"day": "Day",
		"day.create": "Create a Day",
		"day.create.failure": "Failed to create a day with error: ",
		"day.create.name.exists": "Day already exists",
		"day.create.name.required": "Day name is required",
		"day.create.success": "Successfully created a day.",
		"day.delete.button": "Delete Overall Day",
		"day.delete.confirm": "Are you sure you want to delete this day?",
		"day.delete.error": "Failed to delete day.",
		"day.delete.success": "Successfully deleted day.",
		"day.edit": "Details/Edit Day",
		"day.edit.discard": "Discard Overall Changes",
		"day.edit.error": "Failed to edit day.",
		"day.edit.save": "Save Overall Day",
		"day.edit.success": "Successfully edited day.",
		"day.end.hour": "End Hour",
		"day.friday": "Friday",
		"day.monday": "Monday",
		"day.of.week": "Day of Week",
		"day.pattern": "Day Pattern:",
		"day.pattern.required": "Day pattern is required",
		"day.pattern.select": "Select a day pattern",
		"day.saturday": "Saturday",
		"day.segments.delete.confirm.earlier": "Are you sure you want to delete the segment for hours {startHour} - {endHour} and update the previous one?",
		"day.segments.delete.confirm.later": "Are you sure you want to delete the segment for hours {startHour} - {endHour} and update the next one?",
		"day.segments.delete.confirm.button": "Delete Segment",
		"day.segments.delete.invalid.direction": "Invalid direction for segment deletion: {direction}",
		"day.segments.delete.success": "Successfully deleted day segment.",
		"day.segments.edit.start.hour.invalid": "Must be an integer greater than {min} and less than the end hour",
		"day.segments.edit.end.hour.invalid": "Must be an integer greater than the start hour and less than {max}",
		"day.segments.edit.save": "Save Segment",
		"day.segments.split.success": "Successfully split day segment.",
		"day.segments.table.timeRange": "Time Range",
		"day.segments.table.title": "Day Segments Table",
		"day.slope.intercept.zero": "Both the slope and the intercept are zero. Are you sure you want to save this segment?",
		"day.start.hour": "Start Hour",
		"day.sunday": "Sunday",
		...
		"edit.user": "Edit User",
		"edited": "edited",
		"edit.segment.title": "Edit Segment",
		"enable": "Enable",
		...
		"help.admin.daycreate": "This page allows admins to create days. Please visit {link} for further details and information.",
		"help.admin.dayedit": "This page allows admins to edit days. Please visit {link} for further details and information.",
		"help.admin.dayview": "This page shows information on days. Please visit {link} for further details and information.",
		"help.admin.holidayrateview": "This page shows information on holiday rates. Please visit {link} for further details and information.",
		...
		"help.admin.weekcreate": "This page allows admins to create weeks. Please visit {link} for further details and information.",
		"help.admin.weekedit": "This page allows admins to edit weeks. Please visit {link} for further details and information.",
		"help.admin.weekview": "This page allows admins to view and edit weeks. Please visit {link} for further details and information.",
		...
		"holiday.base": "Base Holiday:",
		"holiday.base.changed.warning": "Base holiday changed - make sure the name still matches.",
		"holiday.base.required": "Base holiday is required",
		"holiday.base.select": "Select or search for a holiday...",
		"holiday.base.select.location.first": "Select a location first",
		"holiday.base.unknown": "(unknown holiday)",
		"holiday.country": "Country",
		"holiday.country.select": "Select a country",
		"holiday.date": "Date:",
		"holiday.day.name": "Holiday Day Name:",
		"holiday.history.warning": "The holiday source does not reliably identify when holidays began or ended. Review historical schedules before using these holidays for past data.",
		"holiday.import.button": "Import/Update Holidays",
		"holiday.import.country.required": "Select a country before importing holidays.",
		"holiday.import.failure": "Failed to import holidays: ",
		"holiday.import.success": "Holidays imported/updated: ",
		"holiday.instance.group.create": "Create Holiday Rate Group",
		"holiday.instance.group.create.failure": "Failed to create holiday rate group with error: ",
		"holiday.instance.group.delete": "Delete Holiday Rate Group",
		"holiday.instance.group.delete.confirm": "Are you sure you want to delete this holiday rate group?",
		"holiday.instance.group.delete.failure": "Failed to delete holiday rate group with error: ",
		"holiday.instance.group.details": "Details/Edit Group",
		"holiday.instance.group.edit": "Edit Holiday Rate Group",
		"holiday.instance.group.edit.failure": "Failed to edit holiday rate group with error: ",
		"holiday.instance.group.empty": "None",
		"holiday.instance.groups": "Holiday Rate Groups",
		"holiday.instance.group.load.failure": "Unable to load holiday rate group data from the database.",
		"holiday.instance.group.loading": "Loading holiday rate groups...",
		"holiday.instances": "Holiday Rates: ",
		"holiday.location": "Location:",
		"holiday.location.select": "Select or search for a location...",
		"holiday.location.unavailable": "Unavailable",
		"holiday.none": "No holidays are stored for this location and year.",
		"holiday.rate.create": "Create a Holiday Rate",
		"holiday.rate.create.failure": "Failed to create a holiday rate with error: ",
		"holiday.rate.create.save": "Create Holiday Rate",
		"holiday.rate.create.success": "Successfully created a holiday rate.",
		"holiday.rate.delete": "Delete Holiday Rate",
		"holiday.rate.delete.confirm": "Are you sure you want to delete this holiday rate? This cannot be undone.",
		"holiday.rate.delete.failure": "Failed to delete holiday rate with error: ",
		"holiday.rate.delete.success": "Successfully deleted holiday rate.",
		"holiday.rate.edit": "Details/Edit Holiday Rate",
		"holiday.rate.edit.failure": "Failed to edit holiday rate with error: ",
		"holiday.rate.edit.success": "Successfully edited holiday rate.",
		"holiday.rate.name.required": "Name is required",
		"holiday.rate.none": "No holiday rates have been created yet.",
		"holiday.rate.save": "Save Holiday Rate",
		"holiday.rates": "Holiday Rates",
		"holiday.region.unavailable": "Unavailable",
		"holiday.region": "Region: ",
		"holiday.region.none": "None",
		"holiday.saved": "Saved Holidays",
		"holiday.state": "State/Province:",
		"holiday.state.select": "Select a state or province",
		"holiday.type": "Type:",
		"holiday.type.bank": "Bank",
		"holiday.type.custom": "Custom",
		"holiday.type.observance": "Observance",
		"holiday.type.optional": "Optional",
		"holiday.type.public": "Public",
		"holiday.type.school": "School",
		"holiday.year": "Year:",
		"holiday.year.invalid": "Enter a valid year.",
		"holidays": "Holidays",
		"home": "Home",
		"hour": "Hour",
		...
		"initial.conversion": "Initial Conversion Segment",
		...
		"select.holiday.rates": "Select Holiday Rates",
		...
		"show.all.segments": "Show All Segments",
		"show.grid": "Show grid",
		...
		"split.earlier": "Split\u2191",
		"split.later": "Split\u2193",
		"split.hour.prompt": "Enter the hour to split the segment",
		"split.hour.invalid": "Please enter a valid hour between {start} and {end}",
		"submit": "Submit",
		...
		"website": "website",
		"week": "Week",
		"week.create": "Create a Week",
		"week.create.failure": "Failed to create a week with message: ",
		"week.create.success": "Successfully created a week.",
		"week.delete": "Delete Week",
		"week.delete.confirm": "Are you sure you want to delete this week?",
		"week.delete.failure": "Failed to delete week with message: ",
		"week.delete.success": "Successfully deleted week.",
		"week.edit": "Edit Week",
		"week.edit.failure": "Failed to edit week with message: ",
		"week.edit.success": "Successfully edited week.",
		"week.validation.name.exists": "A week with this name already exists.",
		"weeks": "Weeks",
		"yes": "yes",
		"yesterday": "Yesterday",
	...
	"fr": {
		...
		"conversion.create.failure": "Failed to create a conversion with error: \u{26A1}",
		...
		"conversion.delete.segment.earlier": "Êtes-vous sûr de vouloir supprimer le segment de {start} à {end} et mettre à jour le segment précédent?",
		"conversion.delete.segment.later": "Êtes-vous sûr de vouloir supprimer le segment de {start} à {end} et mettre à jour le segment suivant?",
		...
		"conversion.edit.segment": "Modifier le segment de conversion",
		"conversion.error.datetime.invalid": "Format invalide. Utilisez YYYY-MM-DD HH:mm:ss",
		"conversion.error.segment.splitTime": "L'heure de division doit être strictement comprise entre le début et la fin du segment.",
		"conversion.error.split.beforeStart": "L'heure de division doit être après l'heure de début de ce segment",
		"conversion.error.split.afterEnd": "L'heure de division doit être avant l'heure de fin de ce segment",
		"conversion.error.split.time.invalid": "Heure de découpage invalide. Veuillez utiliser le format AAAA-MM-JJ ou AAAA-MM-JJ HH:mm:ss.",
		...
		"conversion.note": "Noter",
		"conversion.overall": "Conversion Globale",
		"conversion.overall.delete": "Supprimer la conversion globale",
		"conversion.overall.discard": "Annuler les modifications globales",
		"conversion.overall.save": "Enregistrer la conversion globale",
		"conversion.overall.save.error": "Échec de la mise à jour de la conversion.",
		"conversion.overall.save.success": "Conversion mise à jour avec succès.",
		"conversion.overall.subtitle": "Cette section définit la conversion globale entre les unités.",
		"conversion.pattern": "Pattern\u{26A1}",
		"conversion.pattern.no": "No Pattern\u{26A1}",
		"conversion.represent": "Conversion Represent:\u{26A1}",
		"conversion.segment.delete.error": "Une erreur est survenue lors de la suppression du segment.",
		"conversion.segment.delete.success": "Segment de conversion supprimé avec succès.",
		"conversion.segment.split.error": "Une erreur est survenue lors de la scission du segment.",
		"conversion.segment.split.success": "Segment de conversion scindé avec succès.",
		"conversion.segment.save.error": "Une erreur est survenue lors de l'enregistrement du segment.",
		"conversion.segment.save.success": "Segment enregistré avec succès.",
		"conversion.segment.warning.invalidStartRange": "L'heure de début doit être postérieure à l'heure de fin du segment précédent et antérieure à l'heure de fin de ce segment",
		"conversion.segment.warning.invalidEndRange": "L'heure de fin doit être antérieure à l'heure de début du segment suivant et postérieure à l'heure de début de ce segment",
		"conversion.segment.warning.previousAdjusted": "L'heure de fin du segment précédent a été ajustée pour correspondre à la nouvelle heure de début",
		"conversion.segment.warning.previousAdjustFailed": "Échec de l'ajustement du segment précédent.",
		"conversion.segment.warning.nextAdjusted": "L'heure de début du segment suivant a été ajustée pour correspondre à la nouvelle heure de fin",
		"conversion.segment.warning.nextAdjustFailed": "Échec de l'ajustement du segment suivant.",
		"conversion.segments.table": "Table des segments de conversion",
		"conversion.segments.table.subtitle": "Cette section montre comment la conversion fonctionne sur des périodes spécifiques.",
		...
		"conversion.split.datetime.placeholder": "AAAA-MM-JJ HH:mm:ss (complet)",
		"conversion.split.datetime.prompt": "Entrez la date et l'heure (AAAA-MM-JJ HH:mm:ss) pour diviser le segment:",
		...
		"conversion.table.delete.earlier": "Supprimer précédent\u2191",
		"conversion.table.delete.later": "Supprimer suivant\u2193",
		"conversion.table.split.earlier": "Diviser avant\u2191",
		"conversion.table.split.later": "Diviser après\u2193",
		"conversion.time.start": "Heure de début",
		"conversion.time.end": "Heure de fin",
		...
		"day": "Jour",
		"day.create": "Créer un Jour",
		"day.create.failure": "Échec de la création du jour avec l'erreur : ",
		"day.create.name.exists": "Le jour existe déjà",
		"day.create.name.required": "Le nom du jour est requis",
		"day.create.success": "Jour créé avec succès.",
		"day.delete.button": "Delete Overall Day\u{26A1}",
		"day.delete.confirm": "Êtes-vous sûr de vouloir supprimer ce jour?",
		"day.delete.error": "Échec de la suppression du jour.",
		"day.delete.success": "Jour supprimé avec succès.",
		"day.edit": "Détails/Modifier Jour",
		"day.edit.discard": "Discard Overall Changes\u{26A1}",
		"day.edit.error": "Échec de la modification du jour.",
		"day.edit.save": "Save Overall Day\u{26A1}",
		"day.edit.success": "Jour modifié avec succès.",
		"day.end.hour": "Heure de fin",
		"day.friday": "Vendredi",
		"day.monday": "Lundi",
		"day.of.week": "Jour de la semaine",
		"day.pattern": "Day Pattern:\u{26A1}",
		"day.pattern.required": "Day pattern is required\u{26A1}",
		"day.pattern.select": "Select a day pattern\u{26A1}",
		"day.saturday": "Samedi",
		"day.segments.delete.confirm.earlier": "Êtes-vous sûr de vouloir supprimer le segment de {startHour} - {endHour} et mettre à jour le segment précédent?",
		"day.segments.delete.confirm.later": "Êtes-vous sûr de vouloir supprimer le segment de {startHour} - {endHour} et mettre à jour le segment suivant?",
		"day.segments.delete.confirm.button": "Supprimer le Segment",
		"day.segments.delete.invalid.direction": "Invalid direction for segment deletion: {direction}\u{26A1}",
		"day.segments.delete.success": "Successfully deleted day segment.\u{26A1}",
		"day.segments.edit.start.hour.invalid": "Must be an integer greater than {min} and less than the end hour\u{26A1}",
		"day.segments.edit.end.hour.invalid": "Must be an integer greater than the start hour and less than {max}\u{26A1}",
		"day.segments.edit.save": "Enregistrer le Segment",
		"day.segments.split.success": "Successfully split day segment.\u{26A1}",
		"day.segments.table.timeRange": "Plage horaire",
		"day.segments.table.title": "Tableau des segments de jour",
		"day.slope.intercept.zero": "La pente et l'ordonnée à l'origine sont toutes deux nulles. Êtes-vous sûr de vouloir enregistrer ce segment?",
		"day.start.hour": "Heure de début",
		"day.sunday": "Dimanche",
		"day.thursday": "Jeudi",
		"day.tuesday": "Mardi",
		...
		"edited": "édité",
		"edit.segment.title": "Modifier le segment",
		"enable": "Activer",
		...
		"help.admin.weekedit": "This page allows admins to edit weeks. Please visit {link} for further details and information.\u{26A1}",
		...
		"holiday.base.changed.warning": "Base holiday changed - make sure the name still matches.\u{26A1}",
		"holiday.base.required": "Base holiday is required\u{26A1}",
		"holiday.base.select": "Select or search for a holiday...\u{26A1}",
		"holiday.base.select.location.first": "Select a location first\u{26A1}",
		...
		"holiday.history.warning": "The holiday source does not reliably identify when holidays began or ended. Review historical schedules before using these holidays for past data.\u{26A1}",
		"holiday.instances": "Tarifs de jours fériés : ",
		...
		"holiday.import.failure": "Failed to import holidays: \u{26A1}",
		"holiday.import.success": "Holidays imported/updated: \u{26A1}",
		"holiday.instance.group.create": "Créer un groupe de tarifs de jours fériés",
		"holiday.instance.group.create.failure": "Failed to create holiday rate group with error: \u{26A1}",
		"holiday.instance.group.delete": "Supprimer le groupe de tarifs de jours fériés",
		"holiday.instance.group.delete.confirm": "Are you sure you want to delete this holiday rate group?\u{26A1}",
		"holiday.instance.group.delete.failure": "Failed to delete holiday rate group with error: \u{26A1}",
		"holiday.instance.group.details": "Détails/Modifier le groupe",
		"holiday.instance.group.edit": "Modifier le groupe de tarifs de jours fériés",
		"holiday.instance.group.edit.failure": "Failed to edit holiday rate group with error: \u{26A1}",
		"holiday.instance.group.empty": "None\u{26A1}",
		"holiday.instance.groups": "Groupes de tarifs de jours fériés",
		"holiday.instance.group.load.failure": "Unable to load holiday rate group data from the database.\u{26A1}",
		"holiday.instance.group.loading": "Loading holiday rate groups...\u{26A1}",
		"holiday.location": "Location:\u{26A1}",
		"holiday.location.select": "Select or search for a location...\u{26A1}",
		"holiday.location.unavailable": "Unavailable\u{26A1}",
		"holiday.none": "No holidays are stored for this location and year.\u{26A1}",
		"holiday.rate.create": "Create a Holiday Rate\u{26A1}",
		"holiday.rate.create.failure": "Failed to create a holiday rate with error: \u{26A1}",
		"holiday.rate.create.save": "Create Holiday Rate\u{26A1}",
		"holiday.rate.create.success": "Successfully created a holiday rate.\u{26A1}",
		...
		"holiday.rate.delete.failure": "Failed to delete holiday rate with error: \u{26A1}",
		"holiday.rate.delete.success": "Successfully deleted holiday rate.\u{26A1}",
		"holiday.rate.edit": "Details/Edit Holiday Rate\u{26A1}",
		"holiday.rate.edit.failure": "Failed to edit holiday rate with error: \u{26A1}",
		...
		"holiday.region.unavailable": "Indisponible",
		"holiday.saved": "Saved Holidays\u{26A1}",
		...
		"holiday.year.invalid": "Enter a valid year.\u{26A1}",
		...
		"patterns.weekly": "Modèles - Hebdomadaires",
		...
		"show.all.segments": "Afficher tous les segments",
		...
		"split.earlier": "Diviser\u2191",
		"split.later": "Diviser\u2193",
		"split.hour.prompt": "Entrez l'heure pour diviser le segment",
		"split.hour.invalid": "Veuillez entrer une heure valide entre {start} et {end}.",
		"submit": "Soumettre",
		...
		"website": "site web",
		"week": "Semaine",
		"week.create": "Créer une Semaine",
		"week.create.failure": "Échec de la création de la semaine avec le message: ",
		"week.create.success": "Semaine créée avec succès",
		"week.delete": "Supprimer la Semaine",
		"week.delete.confirm": "Êtes-vous sûr de vouloir supprimer cette semaine?",
		"week.delete.failure": "Échec de la suppression de la semaine avec le message: ",
		"week.delete.success": "Semaine supprimée avec succès",
		"week.edit": "Éditer Semaine",
		"week.edit.failure": "Échec de la modification de la semaine avec le message: ",
		"week.edit.success": "Semaine modifiée avec succès",
		"week.validation.name.exists": "Cette semaine existe déjà",
		"weeks": "Semaines",
		"yes": " yes\u{26A1}",
		"yesterday": "Hier",
	...
	"es": {
		...
		"conversion.create.failure": "Failed to create conversion with message: \u{26A1}",
		...
		"conversion.create.success": "Conversión creada con éxito.",
		...
		"conversion.delete.restricted": "This conversion cannot be deleted until the significant consequences of doing this are addressed.\u{26A1}",
		"conversion.delete.suffix.disable": "Deleting this suffix conversion will disable use of suffix\u{26A1}",
		"conversion.delete.segment.earlier": "¿Está seguro de que desea eliminar el segmento de {start} a {end} y actualizar el segmento anterior?",
		"conversion.delete.segment.later": "¿Está seguro de que desea eliminar el segmento de {start} a {end} y actualizar el siguiente segmento?",
		"conversion.delete.unit": "Deleting this conversion between two units of type unit may reduce the possible graphing units for some meter(s) but cannot be known until after the deletion happens.\u{26A1}",
		"conversion.delete.unit.orphan": "Deleting this unit conversion will orphan unit\u{26A1}",
		...
		"conversion.edit.segment": "Editar segmento de conversión",
		"conversion.error.datetime.invalid": "Formato inválido. Use YYYY-MM-DD HH:mm:ss",
		"conversion.error.segment.splitTime": "La hora de división debe estar estrictamente entre el inicio y el fin del segmento.",
		"conversion.error.split.beforeStart": "La hora de división debe estar después de la hora de inicio de este segmento",
		"conversion.error.split.afterEnd": "La hora de división debe estar antes de la hora de fin de este segmento",
		"conversion.error.split.time.invalid": "Hora de división no válida. Utilice el formato AAAA-MM-DD o AAAA-MM-DD HH:mm:ss.",
		...
		"conversion.note": "Nota",
		"conversion.overall": "Conversión General",
		"conversion.overall.delete": "Eliminar la conversión general",
		"conversion.overall.discard": "Descartar los cambios generales",
		"conversion.overall.save": "Guardar la conversión general",
		"conversion.overall.save.error": "Error al actualizar la conversión.",
		"conversion.overall.save.success": "Conversión actualizada correctamente.",
		"conversion.overall.subtitle": "Esta sección define la conversión general entre unidades.",
		"conversion.pattern": "Pattern\u{26A1}",
		"conversion.pattern.no": "No Pattern\u{26A1}",
		"conversion.represent": "La conversión representa:",
		"conversion.segment.delete.error": "Ocurrió un error al eliminar el segmento.",
		"conversion.segment.delete.success": "Segmento de conversión eliminado correctamente.",
		"conversion.segment.split.error": "Ocurrió un error al dividir el segmento.",
		"conversion.segment.split.success": "Segmento de conversión dividido con éxito.",
		"conversion.segment.save.error": "Ocurrió un error al guardar el segmento.",
		"conversion.segment.save.success": "Segmento guardado correctamente.",
		"conversion.segment.warning.invalidStartRange": "La hora de inicio debe ser posterior a la hora de finalización del segmento anterior y anterior a la hora de finalización de este segmento",
		"conversion.segment.warning.invalidEndRange": "La hora de finalización debe ser anterior a la hora de inicio del siguiente segmento y posterior a la hora de inicio de este segmento",
		"conversion.segment.warning.previousAdjusted": "La hora de finalización del segmento anterior se ajustó para coincidir con la nueva hora de inicio",
		"conversion.segment.warning.previousAdjustFailed": "No se pudo ajustar el segmento anterior.",
		"conversion.segment.warning.nextAdjusted": "La hora de inicio del siguiente segmento se ajustó para coincidir con la nueva hora de finalización",
		"conversion.segment.warning.nextAdjustFailed": "No se pudo ajustar el siguiente segmento.",
		"conversion.segments.table": "Tabla de segmentos de conversión",
		...
		"conversion.split.datetime.placeholder": "AAAA-MM-DD HH:mm:ss (completo)",
		"conversion.split.datetime.prompt": "Ingrese la fecha y hora (AAAA-MM-DD HH:mm:ss) para dividir el segmento:",
		...
		"conversion.table.delete.earlier": "Eliminar anterior\u2191",
		"conversion.table.delete.later": "Eliminar siguiente\u2193",
		"conversion.table.split.earlier": "Dividir antes\u2191",
		"conversion.table.split.later": "Dividir después\u2193",
		"conversion.time.start": "Hora de inicio",
		"conversion.time.end": "Hora de finalización",
		...
		"day": "Día",
		"day.create": "Crear un Día",
		"day.create.failure": "No se pudo crear el día con el error: ",
		"day.create.name.exists": "El día ya existe",
		"day.create.name.required": "El nombre del día es requerido",
		"day.create.success": "Día creado con éxito",
		"day.delete.button": "Eliminar el Día General",
		"day.delete.confirm": "¿Estás seguro de que quieres eliminar este día?",
		"day.delete.error": "No se pudo eliminar el día.",
		"day.delete.success": "Día eliminado con éxito.",
		"day.edit": "Detalles/Editar Día",
		"day.edit.discard": "Descartar los cambios generales",
		"day.edit.error": "No se pudo editar el día.",
		"day.edit.save": "Guardar el Día General",
		"day.edit.success": "Día editado con éxito.",
		"day.end.hour": "Hora de finalización",
		"day.friday": "Viernes",
		"day.monday": "Lunes",
		...
		"day.pattern.select": "Select a day pattern\u{26A1}",
		"day.saturday": "Sábado",
		"day.segments.delete.confirm.earlier": "¿Estás seguro de que quieres eliminar el segmento de {startHour} - {endHour} y actualizar el segmento anterior?",
		"day.segments.delete.confirm.later": "¿Estás seguro de que quieres eliminar el segmento de {startHour} - {endHour} y actualizar el segmento siguiente?",
		"day.segments.delete.confirm.button": "Eliminar segmento",
		"day.segments.delete.invalid.direction": "Invalid direction for segment deletion: {direction}\u{26A1}",
		"day.segments.delete.success": "Successfully deleted day segment.\u{26A1}",
		"day.segments.edit.start.hour.invalid": "Must be an integer greater than {min} and less than the end hour\u{26A1}",
		"day.segments.edit.end.hour.invalid": "Must be an integer greater than the start hour and less than {max}\u{26A1}",
		"day.segments.edit.save": "Guardar segmento",
		"day.segments.split.success": "Successfully split day segment.\u{26A1}",
		"day.segments.table.timeRange": "Rango horario",
		"day.segments.table.title": "Tabla de segmentos del día",
		"day.slope.intercept.zero": "Tanto la pendiente como la intersección son cero. ¿Seguro que quieres guardar este segmento?",
		"day.start.hour": "Hora de inicio",
		"day.sunday": "Domingo",
		"day.thursday": "Jueves",
		"day.tuesday": "Martes",
		...
		"edited": "editado",
		"edit.segment.title": "Editar segmento",
		"enable": "Activar",
		...
		"help.admin.weekcreate": "Esta página permite a los administradores crear patrones semanales. Por favor, visite {link} para más detalles e información.",
		"help.admin.weekedit": "Esta página permite a los administradores editar patrones semanales. Por favor, visite {link} para más detalles e información.",
		"help.admin.weekview": "Esta página permite a los administradores ver y editar patrones semanales. Por favor, visite {link} para más detalles e información.",
		...
		"holiday.import.failure": "Failed to import holidays: \u{26A1}",
		"holiday.import.success": "Holidays imported/updated: \u{26A1}",
		"holiday.instance.group.create": "Crear grupo de tarifas de días festivos",
		"holiday.instance.group.create.failure": "Failed to create holiday rate group with error: \u{26A1}",
		"holiday.instance.group.delete": "Eliminar grupo de tarifas de días festivos",
		"holiday.instance.group.delete.confirm": "Are you sure you want to delete this holiday rate group?\u{26A1}",
		"holiday.instance.group.delete.failure": "Failed to delete holiday rate group with error: \u{26A1}",
		"holiday.instance.group.details": "Detalles/Editar grupo",
		"holiday.instance.group.edit": "Editar grupo de tarifas de días festivos",
		"holiday.instance.group.edit.failure": "Failed to edit holiday rate group with error: \u{26A1}",
		"holiday.instance.group.empty": "None\u{26A1}",
		"holiday.instance.groups": "Grupos de tarifas de días festivos",
		"holiday.instance.group.load.failure": "Unable to load holiday rate group data from the database.\u{26A1}",
		"holiday.instance.group.loading": "Loading holiday rate groups...\u{26A1}",
		"holiday.instances": "Tarifas de días festivos: ",
		"holiday.location": "Location:\u{26A1}",
		"holiday.location.select": "Select or search for a location...\u{26A1}",
		"holiday.location.unavailable": "Unavailable\u{26A1}",
		"holiday.none": "No holidays are stored for this location and year.\u{26A1}",
		...
		"holiday.region": "Region:\u{26A1}",
		"holiday.region.none": "None\u{26A1}",
		"holiday.region.unavailable": "No disponible",
		"holiday.saved": "Saved Holidays\u{26A1}",
		"holiday.state": "State/Province:\u{26A1}",
		"holiday.state.select": "Select a state or province\u{26A1}",
		"holiday.type": "Type:\u{26A1}",
		...
		"patterns.daily": "Patrones - Diarios",
		"patterns.weekly": "Patrones - Semanales",
		"per.day": "Por día",
		"per.hour": "Por hora",
		...
		"show": "Mostrar",
		"show.all.logs": "Show All Logs\u{26A1} ",
		"show.all.segments": "Mostrar todos los segmentos",
		...
		"slope": "Pendiente",
		"sort": "Sort Order\u{26A1}",
		"split.earlier": "Dividir\u2191",
		"split.later": "Dividir\u2193",
		"split.hour.prompt": "Ingrese la hora para dividir el segmento",
		"split.hour.invalid": "Por favor ingrese una hora válida entre {start} y {end}.",
		"submit": "Enviar",
		...
		"week.edit.failure": "No se pudo editar la semana con el mensaje: ",
		"week.edit.success": "Semana editada con éxito.",
		"week.validation.name.exists": "Ya existe una semana con este nombre.",
		"weeks": "Semanas",
		"yes": "sí",
		"yesterday": "Ayer",
